package webapp.vladimir.controller;
...
import webapp.vladimir.services.LibraryServices;
...
public class LibController {
	...
	public void MethodForAll(ModelMap model) {
		model.addAttribute("codedBy", "*****Created for FUN!******");
	}
	...
	public ModelAndView ForAddingBooks(@ModelAttribute("librarymodel") LibraryModel librarymodel,
	...
	@RequestMapping(value = "update", method = RequestMethod.POST) // UPDATING
																	// BOOKS
