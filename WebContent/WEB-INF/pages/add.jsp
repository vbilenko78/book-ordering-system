		...
		<tr>
			<td>
				<div class="container text-center">
					<div class="row">
						<h3 style="color: #1E90FF">Add Book to Library</h3>
						<br />
						<div class="col-sm-12">
							<div>
								<form class="form-inline" method="post" action="adding">
									<div class="form-group">
										<label for="bookname">Book Name&nbsp;:</label> <input
											...
											Style="background-color: #cce6ff;" name="name"
											placeholder="Enter Name">
									</div>
									&nbsp;&nbsp;&nbsp;&nbsp;
									<div class="form-group">
										<label for="booktype">Book Type: </label> <select
									...
									&nbsp;&nbsp;&nbsp;&nbsp;
									<div class="form-group">
										<label for="bookedtion">Book Edition&nbsp;:</label> <select
											class="form-control" Style="background-color: #cce6ff;"
											name="edition">
											<option>First</option>
				...
				<div class="container">
					<div style="text-align: center;">
						<h3 style="color: #1E90FF; font-size: 25px">Your Library</h3>
						&nbsp;
					</div>
