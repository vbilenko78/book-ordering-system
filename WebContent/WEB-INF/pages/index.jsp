		...
		<tr>
			<td>
				<div class="container-fluid">
					<div class="row">
						<div class="col-sm-12"
							style="background-color: #003366; text-align: center; padding: 13px;">
							<div>
								<span
									style="text-shadow: 0px 2px 6px #800000; font-size: 17px; color: gold; font-family: initial;">
									MVC Web Application using Spring, Hibernate, Html5, CSS, Bootstrap
									& MySQL</span>
							</div>
			...
			<hr>
				<div class="container text-center">
					<div class="row">
						<h3>Your Home Library</h3>
						<h4>
							<mark>Add, Delete and Update</mark>
						</h4>
						<br />
